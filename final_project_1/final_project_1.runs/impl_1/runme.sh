...
HD_PWD='C:/Users/aliya/OneDrive/Masats/final_project_1/final_project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_LAB_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_LAB_top.tcl -notrace

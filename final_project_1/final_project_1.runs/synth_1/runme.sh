...
HD_PWD='C:/Users/aliya/OneDrive/Masats/final_project_1/final_project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_LAB_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_LAB_top.tcl
